...
class com_win ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"JaysPyCOM", pos = wx.DefaultPosition, size = wx.Size( 700,598 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText_receive = wx.StaticText( self, wx.ID_ANY, u"Receive:", wx.DefaultPosition, wx.Size( 400,25 ), 0 )
		...
		m_choice_plotChoices = [ u"Plot_On", u"Plot_Off" ]
		self.m_choice_plot = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 100,20 ), m_choice_plotChoices, 0 )
		self.m_choice_plot.SetSelection( 0 )
		receive_win.Add( self.m_choice_plot, 0, wx.ALL, 5 )

		m_choice_lineChoices = [ u"Line#1", u"Line#2" ]
		self.m_choice_line = wx.Choice( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 150,20 ), m_choice_lineChoices, 0 )
		self.m_choice_line.SetSelection( 0 )
		receive_win.Add( self.m_choice_line, 0, wx.ALL, 5 )
		...
		self.m_staticText_null1 = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 380,20 ), 0 )
		self.m_staticText_null1.Wrap( -1 )

		receive_win.Add( self.m_staticText_null1, 0, wx.ALL, 5 )

		self.m_button_server = wx.Button( self, wx.ID_ANY, u"Server", wx.DefaultPosition, wx.Size( 100,30 ), 0 )
		receive_win.Add( self.m_button_server, 0, wx.ALL, 5 )
		...
		self.m_choice_plot.Bind( wx.EVT_CHOICE, self.setPlotState )
		self.m_choice_line.Bind( wx.EVT_CHOICE, self.changeAnaline )
		self.m_choice_recvFormat.Bind( wx.EVT_CHOICE, self.setRecvFormat )
		self.m_button_server.Bind( wx.EVT_BUTTON, self.OpenServer )
